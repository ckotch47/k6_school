...
const commonChat = {
    index: 1,
    id: 'baea9cd0-2eb7-42b9-b040-9c7a42b11531',
    type: 'FREE',
    groupId: '',
    conversationId: ''
}

class CuratorWriteToCommonChat{
    close(data){
              ...
              case 'chat':
                ...
                if(recv.func === 'show_history'){
                    socket.send(`42/chat,["send_message", ${JSON.stringify({
                        conversationId: commonChat.conversationId,
                        text: 'socket k6 load - common chat - curator',
                        uploads: [],
                    })}]`)
                }
...
module.exports = new CuratorWriteToCommonChat()